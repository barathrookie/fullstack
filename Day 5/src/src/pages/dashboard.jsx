...
<Navbar2/>
    ...
    <div className="dashboard-container">
      <div className="dashboard-card">
        <h4 className="dashboard-courses">No of Events</h4>
        <br/>
        <br/>
        <p>25</p>
      </div>
      ...
      <div className="dash-images" >
        <img className="image1-dash" src="https://www.microsoft.com/en-us/microsoft-365/blog/wp-content/uploads/sites/2/2012/06/Excel-charts-11.png"></img>
      
        <img className="image2-dash" src="https://powerslides.com/wp-content/uploads/2019/02/Revenue-Bar-Charts-5.png"></img>
      </div>
      </div>
      {/* <div><CourseChart/></div> */}
